...
function BiDirectionalAssociationFlowEdge(props: EdgeProps) {
  return (
    <FloatingEdgeBase
      {...props}
      renderEdge={({ id, edgePath, style, markerEnd }) => {
        ...
        const markerStartId = `association-arrow-start-${id}`;
...
export default memo(BiDirectionalAssociationFlowEdge);