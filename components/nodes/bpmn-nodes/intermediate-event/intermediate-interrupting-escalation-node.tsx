...
import { CircleEndIcon, InterCircleInterruptingEscalation, InterCircleInterruptingMenssage } from "@/components/icons/bpmn-icons";
import useDetachNodes from "@/hooks/use-detach-nodes";

function IntermediateInterruptngEscalation({ data, type, id }: NodeProps<NodeData>) {
  ...
  return (
    ...
    >
      <div className="pt-0 pb-0">
        <InterCircleInterruptingEscalation className={`h-${size} w-${size} text-red-500`} />
      </div>
...
export default memo(IntermediateInterruptngEscalation);
