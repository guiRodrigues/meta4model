...
import { CircleEndIcon, InterCircleInterruptingEscalation, InterCircleInterruptingMenssage, InterCircleNoInterruptingEscalation } from "@/components/icons/bpmn-icons";
import useDetachNodes from "@/hooks/use-detach-nodes";

function IntermediateNoInterruptngEscalation({ data, type, id }: NodeProps<NodeData>) {
  ...
  return (
    ...
    >
      <div className="pt-0 pb-0">
        <InterCircleNoInterruptingEscalation className={`h-${size} w-${size} text-red-500`} />
      </div>
...
export default memo(IntermediateNoInterruptngEscalation);
