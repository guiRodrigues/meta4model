  ...
  return (
    ...
    >
      <div className="pt-0 pb-0">
        <InterCircleNoInterruptingParallelMultiple className={`h-${size} w-${size} text-red-500`} />
      </div>
...
export default memo(IntermediateNoInterruptingParallel);
