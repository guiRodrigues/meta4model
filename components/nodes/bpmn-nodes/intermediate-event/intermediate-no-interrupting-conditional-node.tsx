...
import { CircleEndIcon, InterCircleInterruptingConditional, InterCircleInterruptingMenssage, InterCircleNoInterruptingConditional } from "@/components/icons/bpmn-icons";
import useDetachNodes from "@/hooks/use-detach-nodes";

function IntermediateNoInterruptingConditional({ data, type, id }: NodeProps<NodeData>) {
  ...
  return (
    ...
    >
      <div className="pt-0 pb-0">
        <InterCircleNoInterruptingConditional className={`h-${size} w-${size} text-red-500`} />
      </div>
...
export default memo(IntermediateNoInterruptingConditional);
