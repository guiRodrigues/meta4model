...
import { CircleEndIcon, InterCircleInterruptigSignal, InterCircleInterruptingMenssage, InterCircleInterruptingMultiple, InterCircleInterruptingTimer, InterCircleNoInterruptigSignal, InterCircleThrowSignal } from "@/components/icons/bpmn-icons";
import useDetachNodes from "@/hooks/use-detach-nodes";

function IntermediateInterruptingMultiple ({ data, type, id }: NodeProps<NodeData>) {
  ...
  return (
    ...
    >
      <div className="pt-0 pb-0">
        <InterCircleInterruptingMultiple className={`h-${size} w-${size} text-red-500`} />
      </div>
...
export default memo(IntermediateInterruptingMultiple);
