...
import { CircleEndIcon, InterCircleInterruptigSignal, InterCircleInterruptingMenssage, InterCircleInterruptingTimer } from "@/components/icons/bpmn-icons";
import useDetachNodes from "@/hooks/use-detach-nodes";

function IntermediateInterruptingSignal({ data, type, id }: NodeProps<NodeData>) {
  ...
  return (
    ...
    >
      <div className="pt-0 pb-0">
        <InterCircleInterruptigSignal className={`h-${size} w-${size} text-red-500`} />
      </div>
...
export default memo(IntermediateInterruptingSignal);
