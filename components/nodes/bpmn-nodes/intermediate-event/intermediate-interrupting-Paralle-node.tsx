...
import { CircleEndIcon, InterCircleInterruptigSignal, InterCircleInterruptingMenssage, InterCircleInterruptingMultiple, InterCircleInterruptingParallelMultiple, InterCircleInterruptingTimer, InterCircleNoInterruptigSignal, InterCircleThrowSignal } from "@/components/icons/bpmn-icons";
import useDetachNodes from "@/hooks/use-detach-nodes";

function IntermediateInterruptingParallel ({ data, type, id }: NodeProps<NodeData>) {
  ...
  return (
    ...
    >
      <div className="pt-0 pb-0">
        <InterCircleInterruptingParallelMultiple className={`h-${size} w-${size} text-red-500`} />
      </div>
...
export default memo(IntermediateInterruptingParallel);
