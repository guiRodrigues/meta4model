...
import { CircleEndIcon, InterCircleInterruptingEscalation, InterCircleInterruptingMenssage, InterCircleNoInterruptingEscalation, InterCircleThrowEscalation } from "@/components/icons/bpmn-icons";
import useDetachNodes from "@/hooks/use-detach-nodes";

function IntermediateThrowEscalation({ data, type, id }: NodeProps<NodeData>) {
  ...
  return (
    ...
    >
      <div className="pt-0 pb-0">
        <InterCircleThrowEscalation className={`h-${size} w-${size} text-red-500`} />
      </div>
...
export default memo(IntermediateThrowEscalation);
