...
import { CircleEndIcon, InterCircleInterruptingMenssage, InterCircleInterruptingTimer, InterCircleNoInterruptingTimer } from "@/components/icons/bpmn-icons";
import useDetachNodes from "@/hooks/use-detach-nodes";

function IntermediateMoInterruptingTimer({ data, type, id }: NodeProps<NodeData>) {
  ...
  return (
    ...
    >
      <div className="pt-0 pb-0">
        <InterCircleNoInterruptingTimer className={`h-${size} w-${size} text-red-500`} />
      </div>
...
export default memo(IntermediateMoInterruptingTimer);
