...
import { CircleEndIcon, InterCircleInterruptigSignal, InterCircleInterruptingMenssage, InterCircleInterruptingMultiple, InterCircleInterruptingTimer, InterCircleLink, InterCircleNoInterruptigSignal, InterCircleNoInterruptingMultiple, InterCircleThrowSignal } from "@/components/icons/bpmn-icons";
import useDetachNodes from "@/hooks/use-detach-nodes";

function IntermediateLink ({ data, type, id }: NodeProps<NodeData>) {
  ...
  return (
    ...
    >
      <div className="pt-0 pb-0">
        <InterCircleLink className={`h-${size} w-${size} text-red-500`} />
      </div>
...
export default memo(IntermediateLink);
