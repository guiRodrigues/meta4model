...
import { CircleEndIcon, InterCircleInterruptingConditional, InterCircleInterruptingMenssage } from "@/components/icons/bpmn-icons";
import useDetachNodes from "@/hooks/use-detach-nodes";

function IntermediateInterruptingConditional({ data, type, id }: NodeProps<NodeData>) {
  ...
  return (
    ...
    >
      <div className="pt-0 pb-0">
        <InterCircleInterruptingConditional className={`h-${size} w-${size} text-red-500`} />
      </div>
...
export default memo(IntermediateInterruptingConditional);
