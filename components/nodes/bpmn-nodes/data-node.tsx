...
import { CircleIcon, FileIcon } from "@/components/icons/bpmn-icons";
import useDetachNodes from "@/hooks/use-detach-nodes";

function DataNode({ data, type, id }: NodeProps<NodeData>) {
  ...
  return (
    ...
    >
      <div className="pt-0 pb-0">
        <FileIcon className={`h-${size} w-${size} text-black`} />
      </div>
