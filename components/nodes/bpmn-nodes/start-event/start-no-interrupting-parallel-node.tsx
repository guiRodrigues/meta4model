...
import { CircleInterruptingMultiple, CircleInterruptingParallelMultiple, CircleNoInterruptingMultiple, CircleNoInterruptingParallelMultiple, CircleNoInterruptingTime } from "@/components/icons/bpmn-icons";

function StartNoInterruptingParallelMultiple({ data, type, id }: NodeProps<NodeData>) {
  ...
  return (
    ...
    >
      <div className="pt-0 pb-0">
        <CircleNoInterruptingParallelMultiple className={`h-${size} w-${size} text-green-500`} />
      </div>
...
export default memo(StartNoInterruptingParallelMultiple);
