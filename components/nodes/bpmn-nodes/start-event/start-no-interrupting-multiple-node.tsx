...
function StartNoInterruptingMultiple({ data, type, id }: NodeProps<NodeData>) {
  ...
  return (
    ...
    >
      <div className="pt-0 pb-0">
        <CircleNoInterruptingMultiple className={`h-${size} w-${size} text-green-500`} />
      </div>
...
export default memo(StartNoInterruptingMultiple);
