...
import { CircleIcon, CircleInterruptingSignal, CircleInterruptingTime, CircleNoInterruptingSignal } from "@/components/icons/bpmn-icons";

function StartNoInterruptingSignal({ data, type, id }: NodeProps<NodeData>) {
  ...
  return (
    ...
    >
      <div className="pt-0 pb-0">
        <CircleNoInterruptingSignal className={`h-${size} w-${size} text-green-500`} />
      </div>
...
export default memo(StartNoInterruptingSignal);
