...
import { CircleInterruptingMultiple, CircleNoInterruptingMultiple, CircleNoInterruptingTime } from "@/components/icons/bpmn-icons";
import useDetachNodes from "@/hooks/use-detach-nodes";

function StartInterruptingMultiple({ data, type, id }: NodeProps<NodeData>) {
  ...
  return (
    ...
    >
      <div className="pt-0 pb-0">
        <CircleInterruptingMultiple className={`h-${size} w-${size} text-green-500`} />
      </div>
...
export default memo(StartInterruptingMultiple);
