...
import { CircleIcon, CircleInterruptingSignal, CircleInterruptingTime } from "@/components/icons/bpmn-icons";
import useDetachNodes from "@/hooks/use-detach-nodes";

function StartInterruptingSignal({ data, type, id }: NodeProps<NodeData>) {
  ...
  return (
    ...
    >
      <div className="pt-0 pb-0">
        <CircleInterruptingSignal className={`h-${size} w-${size} text-green-500`} />
      </div>
...
export default memo(StartInterruptingSignal);
