...
import { CircleIcon, CircleInterruptingConditional, CircleInterruptingError } from "@/components/icons/bpmn-icons";

function StartInterruptingError({ data, type, id }: NodeProps<NodeData>) {
  ...
  return (
    ...
    >
      <div className="pt-0 pb-0">
        <CircleInterruptingError className={`h-${size} w-${size} text-green-500`} />
      </div>
...
export default memo(StartInterruptingError);
