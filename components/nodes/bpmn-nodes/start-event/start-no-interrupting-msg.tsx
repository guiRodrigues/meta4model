...
import { CircleIcon, CircleIntermediateIcon, CircleNoninterruptingMessage } from "@/components/icons/bpmn-icons";

function StartNoninterruptingMessage({ data, type, id }: NodeProps<NodeData>) {
  ...
  return (
    ...
    >
      <div className="pt-0 pb-0">
        <CircleNoninterruptingMessage className={`h-${size} w-${size} text-green-500`} />
      </div>
...
export default memo(StartNoninterruptingMessage);
