...
import { CircleIcon, CircleInterruptingConditional } from "@/components/icons/bpmn-icons";
import useDetachNodes from "@/hooks/use-detach-nodes";

function StartInterruptingConditional({ data, type, id }: NodeProps<NodeData>) {
  ...
  return (
    ...
    >
      <div className="pt-0 pb-0">
        <CircleInterruptingConditional className={`h-${size} w-${size} text-green-500`} />
      </div>
...
export default memo(StartInterruptingConditional);
